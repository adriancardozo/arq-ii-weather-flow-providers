...
OPEN_WEATHER_MAP_CB_THRESHOLD=<open_weather_map_circuit_breaker_threshold (default: 10)>
OPEN_WEATHER_MAP_CB_TIMEOUT=<open_weather_map_circuit_breaker_timeout (default 3 minutes: 180000)>
```
